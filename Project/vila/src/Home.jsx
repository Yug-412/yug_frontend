                        ...
                        <div className="row">
                            <div className="col-lg-4">
                                <div className="left-image">
                                    ...
                                    <a href=""><img src="assets/images/featured-icon.png" alt style={{ maxWidth: 60, padding: 0 }} /></a>
                                </div>
                            </div>
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="item">
                                    ...
                                    <h6>$584.500</h6>
                                    <h4><a href="">12 New Street Miami, OR 12650</a></h4>
                                    <ul>
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="item">
                                    ...
                                    <h6>$925.600</h6>
                                    <h4><a href="">34 Beach Street Miami, OR 42680</a></h4>
                                    <ul>
                                        <li>Bedrooms: <span>4</span></li>
                                        <li>Bathrooms: <span>4</span></li>
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="item">
                                    ...
                                    <h6>$450.000</h6>
                                    <h4><a href="">22 New Street Portland, OR 16540</a></h4>
                                    <ul>
